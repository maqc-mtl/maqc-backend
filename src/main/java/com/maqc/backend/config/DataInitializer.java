...
// agent1.setBio("Experienced real estate agent specializing in luxury
// properties");
...
// createProperty("Triplex à vendre", "1994-1998, boulevard De Maisonneuve,
// Montreal",
...
// createProperty("Maison de plain-pied", "4530 Rue de la Roche, Montreal",
// 849000, 3, 2,
...
// createProperty("Propriété Test A (High Price)", "Test Address A", 1000000, 4,
// 3,
...
// createProperty("Propriété Test B (Low Price)", "Test Address B", 500000, 3,
// 2,
...
// agent2, null, Property.PropertyStatus.APPROVED),
// createProperty("Maison à étages", "782 Rue Gariépy, Quebec City", 925000, 4,
// 3, 8, 1990,
...
// agent2, null, Property.PropertyStatus.APPROVED),
// createProperty("Maison contemporaine", "2345 Rue Sherbrooke E., Montreal",
// 1250000, 4,
...
// createProperty("Condo à vendre", "1200 Rue Saint-Alexandre, apt. 402,
// Montreal", 549000,
// 1, 1, 2, 2015, false, false, false, 24000.0, 8000.0,
// Property.PropertyType.CONDO, Property.ListingType.FOR_SALE,
// "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=800",
// agent1, null, Property.PropertyStatus.APPROVED),
// createProperty("Magnifique Loft", "101 Rue de la Commune E., Montreal",
// 725000, 1, 1,
...
// createProperty("Pied-à-terre Moderne", "1500 Rue University, Montreal",
// 399000, 1, 1,
// 2, 2020, false, false, false, 18000.0, 6000.0,
// Property.PropertyType.CONDO, Property.ListingType.FOR_SALE,
// "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&q=80&w=800",
// agent2, null, Property.PropertyStatus.APPROVED),
// createProperty("Condo de Luxe", "1100 Rue de la Montagne, Montreal", 899000,
// 2, 2,
...
// // Montreal area - House
// createProperty("Maison jumelée", "3450 Avenue du Parc, Montreal", 1350000, 5,
// 3,
...
// // Sherbrooke area
// createProperty("Villa d'Exception", "12 Shoreline Dr, Sherbrooke", 4200000,
// 6, 5,
...
// agent3, null, Property.PropertyStatus.APPROVED),
// // Laval area
// createProperty("Maison spacieuse à Laval", "1230 Boulevard Saint-Martin,
// Laval", 750000,
...
// agent1, null, Property.PropertyStatus.APPROVED),
// // Westmount
// createProperty("Luxury Home Westmount", "4500 Avenue de Westmount,
// Westmount", 2500000,
...
// agent2, null, Property.PropertyStatus.APPROVED),
// // Brossard
// createProperty("Condo moderne Brossard", "5000 Rue de la Seigneurie,
// Brossard", 425000,
...
// // Longueuil
// createProperty("Maison familiale Longueuil", "8900 Rue Saint-Laurent,
// Longueuil",
...
// agent2, null, Property.PropertyStatus.APPROVED),
// // Lévis
// createProperty("Maison avec vue", "450 Rue de la Rivière, Lévis", 550000, 3,
// 2,
...
// createProperty("Triplex à vendre", "Lots des Érables, Montreal", 350000, 0,
// 0, 0, 1980,
...
// createProperty("Duplex investissement", "Avenue du Parc, Montreal", 425000,
// 0, 0, 0,
// 1950, false, false, false, 38000.0, 7000.0,
// Property.PropertyType.PLEX, Property.ListingType.FOR_SALE,
// "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=800",
// agent2, 6.2, Property.PropertyStatus.PENDING),
// createProperty("Triplex revenue", "Rue Saint-Laurent, Montreal", 525000, 0,
// 0, 0, 1965,
...
// createProperty("Restaurant d'élite", "Vieux-Montréal, Quebec", 850000, 0, 0,
// 0, 2015,
...
// createProperty("Bureau médical", "Complexe santé, Montreal", 650000, 0, 0, 0,
// 2018,
...
// createProperty("Espace commercial", "Centre commercial Place Versailles,
// Laval",
...
// "Luxury residence with modern amenities and beautiful architectural
// details.");
// property.setPrice(new BigDecimal(400000 + (i * 25000)));
// // Use only the three city types: montreal, quebec, sherbrooke
// String[] cities = { "montreal", "quebec city", "sherbrooke", "laval",
// "westmount",
...
// if (!isForRent) {
// // Calculate reasonable annual rent based on property price (0.5-0.8% of
// price)
// double annualRevenue = property.getPrice().doubleValue() * (0.005 + (i % 30)
// * 0.0001);
// double annualExpenses = annualRevenue * (0.2 + (i % 10) * 0.02); // 20-40% of
// rent
// property.setAnnualRevenue(annualRevenue);
...
// property.setPublishDate(java.time.LocalDateTime.now().minusDays((long) (i *
// 2)));
// propertyRepository.save(property);
// }
// }

// private Property createProperty(String title, String address, double price,
// int beds, int baths, int rooms,
// Integer yearBuilt,
// Boolean hasTerrace, Boolean hasPool, Boolean hasYard, Double annualRevenue,
// Double annualExpenses,
// Property.PropertyType type, Property.ListingType listingType, String
// imageUrl, User user,
// Double yield, Property.PropertyStatus status, Property.BusinessType
// businessType) {
...
// p.setAnnualRevenue(annualRevenue);
...
// p.setPublishDate(java.time.LocalDateTime.now().minusDays((long)
// (Math.random() * 30)));
// return p;
// }
...
// return createProperty(title, address, price, beds, baths, rooms, yearBuilt,
// hasTerrace, hasPool,
// hasYard, annualRevenue, annualExpenses, type, listingType, imageUrl, user,
// yield,
// status,
// null);
// }
